        ...
        <div className={s.controlWrapper}>
          <div className={s.inputWrapper}>
            <input
              ...
              className={`${s.input} ${s.passwordInput}  ${pass1Error ? s.redBorder : ''}`}
          ...
          {pass1Error && (
            <p className={s.errorMessage}>{pass1Error}</p>
          )}
        </div>
        ...
        <div className={s.controlWrapper}>
          <div className={s.inputWrapper}>
            <input
              id="password"
              autoComplete="current-password"
              className={`${s.input} ${s.passwordInput}  ${pass2Error ? s.redBorder : ''}`}
          ...
          {pass2Error && (
            <p className={s.errorMessage}>{pass2Error}</p>
          )}
        </div>
